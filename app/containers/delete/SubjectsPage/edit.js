          ...
          <div className='bg-light p-3'>
            <div className="row">
              <div className='col-md-4 mb-4'>
                <label>{labels.SUBJECT_NAME}{astrix}</label>
              ...
              <div className='col-md-4 mb-4'>
                <label>{labels.DEPARTMENT}{astrix}</label>
                <input type='text' className='form-control' {...register("department", basicValidationRules)} />
                <ErrorMessage errors={errors} name="department" render={({ message }) => <p className='text-danger fs-6 fst-italic'>{message}</p>} />
              </div>
              <div className='col-md-4 mb-4'>
                <label>{labels.SUBJECT_CODE}{astrix}</label>
                <input type='text' className='form-control' {...register("subjectCode", basicValidationRules)} />
                <ErrorMessage errors={errors} name="subjectCode" render={({ message }) => <p className='text-danger fs-6 fst-italic'>{message}</p>} />
              </div>
            </div>
            <div className='row'>
              <div className='col-md-4 mb-4'>
                <label>{labels.CLASS_NAME}{astrix}</label>
                <AsyncDropdown name='classes' control={control} dataType={'classes'} isMulti={true} rules={{ ...validationRules.required }}/>
                <ErrorMessage errors={errors} name="classes" render={({ message }) => <p className='text-danger fs-6 fst-italic'>{message}</p>} />              </div>
            </div>
          </div>
