    ...
    <div className="">
      ...
      <div className="pageContent shadow-sm-up bg-white ">
        <div className="row">
          ...
          <HtmlTableBuilder json={_.omit({...formData, class: `${formData && formData.class && formData.class.name}${formData && formData.class && formData.class.section}` }, ['firstName', 'lastName', 'primaryMobile', 'id', 'middleName','parents','addresses'])} cols={3} mode={'view'}  />
         </div>
         </div>
         </div>          
        </div>
